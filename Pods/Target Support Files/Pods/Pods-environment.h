...
// VTextView
#define COCOAPODS_POD_AVAILABLE_VTextView
#define COCOAPODS_VERSION_MAJOR_VTextView 0
#define COCOAPODS_VERSION_MINOR_VTextView 1
#define COCOAPODS_VERSION_PATCH_VTextView 0
